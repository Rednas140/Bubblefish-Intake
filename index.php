...
<body class="row">
    <nav class="col p-0 sideNav">
        <header class="text-center my-5 pb-3">
            <img src="./assets/customers-icon_2021-06-13/customers-icon.png" alt="Logo van Bubblefish">
            <h1 class="display-1 fs-1 fw-bolder">Bubblefish Agency</h1>
        </header>
        <div class="btn-group-vertical w-100 my-5 py-5" role="group" aria-label="Navigatie van de webpaginas">
            <a class="w-100 btn-hover" href="#">
        ...
        <footer class="btn-group-vertical w-100 pb-3 my-5 pt-5" role="group" aria-label="Instellingen en logout">
                <a class="w-100 btn-footer" href="#">
        ...
        <div class="row justify-content-center mt-5">
            <div class="card col-md-auto px-0 mx-4 border border-0" style="width: 20rem;">
                ...
                <div class="card-body row align-items-center justify-content-center pt-0">
                    <p class="card-text col-4 card-titletext display-5 text-center mb-0 fw-bolder">36</p>
                ...
                <div class="card col-md-auto px-0 mx-4 border border-0" style="width: 20rem;">
                    <img src="./assets/image_2021-06-13/image.png" class="card-img-top banner-img" alt="banner afbeelding" srcset="./assets/image_2021-06-13/image.png 1x, ./assets/image_2021-06-13/image@2x.png 2x, ./assets/image_2021-06-13/image@3x.png 3x,">
                    <div class="card-body row align-items-center justify-content-center pt-0">
                        <p class="card-text col-4 card-titletext display-5 text-center mb-0 fw-bolder">45</p>
                ...
                <div class="card col-md-auto px-0 mx-4 border border-0" style="width: 20rem;">
                    <img src="./assets/image_2021-06-13/image.png" class="card-img-top banner-img" alt="banner afbeelding" srcset="./assets/image_2021-06-13/image.png 1x, ./assets/image_2021-06-13/image@2x.png 2x, ./assets/image_2021-06-13/image@3x.png 3x,">
                    <div class="card-body row align-items-center justify-content-center pt-0">
                        <p class="card-text col-4 card-titletext display-5 text-center mb-0 fw-bolder">41</p>
                ...
                <div class="card col-md-auto px-0 mx-4 border border-0" style="width: 20rem;">
                    <img src="./assets/image_2021-06-13/image.png" class="card-img-top banner-img" alt="banner afbeelding" srcset="./assets/image_2021-06-13/image.png 1x, ./assets/image_2021-06-13/image@2x.png 2x, ./assets/image_2021-06-13/image@3x.png 3x,">
                    <div class="card-body row align-items-center justify-content-center pt-0">
                        <p class="card-text col-4 card-titletext display-5 text-center mb-0 fw-bolder">4</p>
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="card col-md-auto px-0 mx-2 border-0 d-flex justify-content-center" style="width: 28vw;">
                <div class="card-body row justify-content-center">
                    ...
                    <div class="border-0 row card-login align-content-center justify-content-center" style="width: 90%;">
                        <div class="col-2 p-0 me-4 my-2">
