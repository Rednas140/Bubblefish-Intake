...
$_SESSION["companies"] = $data['companies'];
$_SESSION["customers"] = $data['customers'];
...
<body class="row">
    <nav class="col-2 p-0 sideNav row">
        ...
        <div class="align-self-center btn-group-vertical w-100 mt-0 pb-5 pe-0" role="group" aria-label="Navigatie van de webpaginas">
            <a class="w-100 btn-hover py-3 active-btn" href="./index.php" aria-label="link naar de dashboard">
    ...
    <main class="col-10 main-content">
        ...
        <div class="row justify-content-center mt-5">
            ...
            <div class="card col-md-auto px-0 my-4 mx-4 border-0 card-data">
                <img src="./assets/image_2021-06-13/image.png" class="card-img-top banner-img" alt="banner afbeelding" srcset="./assets/image_2021-06-13/image.png 1x, ./assets/image_2021-06-13/image@2x.png 2x, ./assets/image_2021-06-13/image@3x.png 3x,">
                <div class="card-body row align-items-center justify-content-center pt-0">
            ...
            <div class="card col-6 px-0 my-4 mx-4 border-0 card-data">
                <img src="./assets/image_2021-06-13/image.png" class="card-img-top banner-img" alt="banner afbeelding" srcset="./assets/image_2021-06-13/image.png 1x, ./assets/image_2021-06-13/image@2x.png 2x, ./assets/image_2021-06-13/image@3x.png 3x,">
                <div class="card-body row align-items-center justify-content-center pt-0">
        ...
        <div class="row justify-content-center mt-5">
            <div class="card col-md-auto px-0 mx-2 border-0 card-chart" style="width: 45vw;">
            ...
            <div class="card col-6 px-0 mx-2 border-0 card-profiles">
